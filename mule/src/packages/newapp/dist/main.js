...
/*!***********************!*\
  !*** ./metadata.json ***!
  \***********************/
/*! exports provided: type, name, category, autostart, singleton, hidden, icon, server, groups, strictGroups, title, description, mimes, files, default */
/***/ (function(module) {

module.exports = JSON.parse("{\"type\":\"application\",\"name\":\"new-app\",\"category\":\"other\",\"autostart\":false,\"singleton\":false,\"hidden\":false,\"icon\":\"icon.png\",\"server\":\"server.js\",\"groups\":[],\"strictGroups\":true,\"title\":{\"en_EN\":\"My Application\"},\"description\":{\"en_EN\":\"My Application\"},\"mimes\":[\"^image/(.*)\",\"^video/(.*)\"],\"files\":[\"main.js\",\"main.css\"]}");
