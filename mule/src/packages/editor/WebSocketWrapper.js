...
var WebSocketWrapper = new Proxy(WS, {
    construct: function (target, args) {
        ...
        var receiveFilter = function (msg) {
            return msg;
        };
        //A hook to allow an outgoing message be filtered
        var sendFilter = function (msg) {
            return msg;
        };
        //add the hook
        var addEventListenerProxy = new Proxy(instance.addEventListener, {
        ...
        var sendProxy = new Proxy(instance.send, {
            apply: function (target, thisArg, args) {
